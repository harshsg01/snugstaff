...
const EditFeaturedImage = (existingimage) => {
  ...
  const handleEditClick = async () => {
    ...
    try {
      ...
      const data = {
        uid: listing.id,
        featured_image: updatedImagesList[0],
      };
      if (updatedImagesList.length < 2) {
        ...
        console.log("Error: Upload only 1 image");
        setImageerror('Upload only 1 image')
  ...
  return (
    <Stack>
      ...
      {imageerror === 'Upload only 1 image' && (
