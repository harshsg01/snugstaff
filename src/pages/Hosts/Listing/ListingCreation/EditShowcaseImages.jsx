...
const EditShowCaseImages = (existingimage) => {
  ...
  const handleEditClick = async () => {
    ...
    try {
      ...
      const data = {
        uid: listing.id,
        showcased_images: updatedImagesList,
      };
      console.log(data);
      if (updatedImagesList.length > 2) {
        ...
        console.log("Error: Select minimum of 3 images");
        setImageerror('Select minimum of 3 images')
  ...
  return (
    ...
    <Stack>
      ...
      {imageerror === 'Select minimum of 3 images' && (
        <Typography variant="body1" color={"red"} style={{fontSize:'15px'}}>
            * Select a minimum of 3 images
          </Typography>
      )}
...
export default EditShowCaseImages;