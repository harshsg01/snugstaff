...
const HostTotalpayment = () => {
    ...
    const handlemonthlypayment = (paymentId) => {
        navigate("/host/paymentmonthly/" + paymentId)
    }

    const handlesubscriptionpayment = (paymentId) => {
      navigate("/host/paymentsubscription/" + paymentId)
  }
  ...
  return (
    ...
    <Box sx={{ width: " 65%", margin: "50px auto" }}>
      ...
      {activeTab === 'monthly' &&
        monthlypayment?.monthly_serializer?.map((item) => (
        <>
        <Stack onClick={() => handlemonthlypayment(item?.id)} style={{cursor: "pointer"}}>
            <Typography
            marginBlock={3}
            fontSize={"1.2rem"}
            variant="subtitle1"
      ...
      {activeTab === 'subscription' &&
        ...
        <>
        <Stack onClick={() => handlesubscriptionpayment(item?.id)} style={{cursor: "pointer"}}>
            <Typography
            marginBlock={3}
            fontSize={"1.2rem"}
            variant="subtitle1"
...
export default HostTotalpayment
